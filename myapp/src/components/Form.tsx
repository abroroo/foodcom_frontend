      ...
      {currentQuestion === 1 && (
        <div className=" mx-auto w-full ">
          ...
          <div className="flex items-center justify-center">
            ...
            >
              <>
                <FontAwesomeIcon icon={faCaretLeft} className="mr-1 h-5 w-2 " />{" "}
                뒤로
              </>
            </motion.button>
                ...
                sliderPeopleNum !== 0
                  ...
                  : {
                      background: `rgba(${parseInt(
                        ...
                        16
                      )}, ${parseInt(buttonBackground.slice(5, 7), 16)}, 0.3)`,
                      color: "#fff",
                      border: "1px solid #fff",
                    }
              }
        ...
        <div className=" mx-auto mt-16 w-full md:mt-0">
          ...
          <div className="flex flex-wrap justify-center">
            ...
            <motion.label
              ...
              style={{
                background: checkedOption === "체육관" ? buttonBackground : "",
            ...
            <motion.label
              ...
              style={{
                background: checkedOption === "연회장" ? buttonBackground : "",
          ...
          <div className="grid grid-cols-3 justify-center md:flex md:flex-wrap">
            ...
            >
              <input
                ...
                onChange={handleCheckboxAccesories}
              />
              <span className="pl-1 text-[12px] md:text-[15px]">필요없음</span>
            </motion.label>
        ...
        <>
          ...
          <div className="flex w-full flex-col items-center justify-center xl:hidden">
            ...
            >
              ...
              <div className="flex items-start justify-between">
                {" "}
                <p>장소: </p>
                <span className="pl-1 font-light">{formData.event_place}</span>
              </div>
              <div className="flex items-start justify-between">
                {" "}
                <p>필요한 품목: </p>
              ...
              <div className="flex items-start justify-between">
                {" "}
                <p>전화번호: </p>
                <span className="pl-1 font-light">{formData.phone_number}</span>
              </div>
              <div className="flex items-start justify-between">
                {" "}
                <p>추가 참고 사항: </p>
          ...
          <div className="flex w-full items-center justify-center">
            <motion.button
              ...
              onClick={() => {
                setCurrentQuestion(currentQuestion - 1)
                setCustomerName(""), setPhoneNumber(""), setCustomerMessage("")
              }}
            >
              <>
                <FontAwesomeIcon icon={faCaretLeft} className="mr-1 h-5 w-2" />{" "}
