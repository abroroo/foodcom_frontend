...
const index: React.FC = () => {
  return (
    <motion.div className="flex h-screen w-screen flex-col items-center justify-center overflow-scroll bg-[#fff] font-outfit text-[#49111c]  ">
      <main className="container mx-auto mt-32 h-full md:mt-[13rem]   ">
        ...
        <div className=" relative bottom-0 left-0 w-full flex-col   p-4 text-[11px] text-[#49111c] md:text-[13px] ">
